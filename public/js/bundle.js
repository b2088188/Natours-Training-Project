      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 10:
            ...
            (0, _alerts.showAlert)('error', _data.message);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            (0, _alerts.showAlert)('error', 'Error Logout!');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            (0, _alerts.showAlert)('success', "".concat(type[0].toUpperCase() + type.slice(1), " update success"));
            _context.next = 13;
            break;
...
var stripe = Stripe('pk_test_51I1RsJLbA09BGGD0g1P70qa12Mcf5rKuF7sYm5Qx1D7aWOtHgRFeiIbQpd1uvQbtjxcLyJQpzTdDkV1Im7hvukdm00YzSUZzQL');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            document.querySelector('.btn--save--password').textContet = 'Updating ...';
          ...
          case 7:
            document.querySelector('.btn--save--password').textContet = 'Save Password';
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "2135" + '/');
